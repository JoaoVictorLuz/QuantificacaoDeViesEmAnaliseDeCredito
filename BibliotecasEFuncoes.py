...
def preparando_experimentos():
  ...
  list_gbt_params = []
  for estimators in range(500, 601, 100):
    for samples in range(300, 351, 50):
      for learning in [0.1, 0.2, 0.3]:
  ...
  list_rf_params = []
  for estimators in range(500, 801, 100):
    for samples in range(300, 401, 50):
